<form action="<?php menu_page_url(OP_SN) ?>" method="post" enctype="multipart/form-data" class="op-bsw-settings">
	...
	<div class="op-bsw-main-content">
		...
		if (($browser['name'] === 'msie') ||
			...
			$browser_warning = sprintf(__('We have detected you are using %1s. For optimal performance when using OptimizePress, we recommend using the latest versions of %2s or %3s.', OP_SN), $browser_info, $firefox_link, $chrome_link);
