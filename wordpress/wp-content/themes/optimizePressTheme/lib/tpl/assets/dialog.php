<div id="op_asset_browser_container" style="display:none">
	<ul id="op_asset_browser_slider">
    	...
    	<li id="op_asset_browser_slide2" class="op_asset_browser_slide">
        	<div class="op_asset_content">
        		<div class="asset-title cf"><a href="#1" class="op-slide-link tooltip animated pulse" title="<?php esc_attr_e('Choose a Different Element', OP_SN); ?>"></a><span class="title-text"><?php _e('Choose the Element Style', OP_SN)?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_2') ?></div></div>
    	...
    	<li id="op_asset_browser_slide3" class="op_asset_browser_slide">
        	<div class="op_asset_content">
        		<div class="asset-title cf"><a href="#2" class="op-slide-link tooltip animated pulse" title="<?php esc_attr_e('Choose a Different Element Style', OP_SN); ?>"></a><span class="title-text"><?php _e('Step 3', OP_SN)?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_3') ?></div></div>
    	...
    	<li id="op_asset_browser_slide4" class="op_asset_browser_slide">
        	<div class="op_asset_content">
        		<div class="asset-title cf"><a href="#3" class="op-slide-link tooltip animated pulse" title="<?php esc_attr_e('Choose a Different Element Setting', OP_SN); ?>"></a><span class="title-text"><?php _e('Step 4', OP_SN)?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_4') ?></div></div>
            </div>
        </li>
    </ul>
