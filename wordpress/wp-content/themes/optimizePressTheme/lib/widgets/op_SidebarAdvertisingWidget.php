...
class OP_SidebarAdvertisingWidget extends WP_Widget {
	...
	parent::WP_Widget(false, __('OptimizePress: Advertising Block', OP_SN), array('description' => sprintf(__('Displays ad blocks in the sidebar. Can be enabled and customized from the <a href="%s">Blog Settings > Modules > Sidebar Advertising</a> section.', OP_SN), admin_url('admin.php?page=optimizepress-theme-settings#modules'))));
    }
