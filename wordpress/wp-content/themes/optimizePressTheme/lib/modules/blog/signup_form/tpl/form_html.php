...
<div class="op-signup_form-form_html<?php echo $signup_form_additional_class; ?>">
    ...
    <p class="gotowebinar_list_field cf<?php if ($fields['gotowebinar_enabled']) { echo ' hidden-el'; } ?>">
        ...
        <select id="<?php echo $id ?>method" name="<?php echo $fieldname ?>[form_html][gotowebinar]" class="gotowebinar_select" data-default="<?php echo rawurldecode($fields['gotowebinar']); ?>">
            <?php
