						...
						form_html: {
							...
							fields: {
								...
								list: {
									title: 'provider_list',
									type: 'select',
									showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot']},
									events: {
										change: function(e) {
											/*
								...
								thank_you_page: {
									...
									showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'aweber', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot']}
								},
								action_page: {
									type: 'hidden',
								...
								disable_name: {
									...
									events: {
										change: function(){
											// console.log(OP_AB.get_selector_value('op_assets_core_optin_box_style_container'));
											func = 'block';
									...
									showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['email', 'custom', 'oneshoppingcart', 'mailchimp', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot']}
								},
								name: {
									title: 'name',
									type: 'select',
								...
								extra_fields: {
									...
									showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['custom', 'oneshoppingcart', 'mailchimp', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot']}
								},
								gotowebinar : {
									title: 'gotowebinar',
									type: 'select',
								...
								// gotowebinar_first_name: {
								// 	title: 'gotowebinar_first_name',
								// 	type: 'select',
								// 	showOn: {field:'step_2.tabs.tabs.form_html.fields.gotowebinar',value:'Y'}
								// },
								// gotowebinar_last_name: {
								// 	title: 'gotowebinar_last_name',
								// 	type: 'select',
								// 	showOn: {field:'step_2.tabs.tabs.form_html.fields.gotowebinar',value:'Y'}
								// }
							}
			...
			switch (attrs.form_html.integration_type) {
				...
				case 'infusionsoft':
					nattrs = $.extend(nattrs, {
						...
						name_default: attrs.content.name_default,
						name_order: attrs.form_html.name_order,
