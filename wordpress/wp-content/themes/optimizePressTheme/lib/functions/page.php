...
function op_page_header($color=''){
	...
	if((($nav = op_get_var($header_layout,'nav_bar_above',array())) !== false) && op_get_var($nav,'enabled') == 'Y' && !empty($nav['nav'])):
		?>
		<div class="nav-bar-above page-header cf">
			<div class="fixed-width">
				<div class="twentyfour columns">
					...
					if(isset($nav['nav']) && !empty($nav['nav'])){
						...
						if (!empty($nav['font_family']) || !empty($nav['font_size']) || !empty($nav['font_weight'])){
							$nav_bar_above_font_styles = '
								<style>
									.nav-bar-above.page-header nav.navigation ul li a{
										';
	...
	?>
		...
		?>
		<div class="nav-bar-below page-header<?php echo $color == '' ? '' :' page-header-'.$color ?> cf">
			<div class="fixed-width">
				<div class="twentyfour columns">
                	<?php
					if(isset($nav['logo']) && !empty($nav['logo'])){
...
function op_page_advanced_color_scheme($css){
	...
	$options = array(
		...
		'nav_bar_above' => array(
			...
			array('color','.nav-bar-above a','nav_bar_link'),
			...
			array('color','body .container .nav-bar-above .navigation ul li ul li:hover > a,body .container .nav-bar-above .navigation ul li ul a:focus','nav_bar_dd_link'),
		...
		'nav_bar_below' => array(
			array('gradient','.nav-bar-below.page-header','nav_bar_start','nav_bar_end','is_gradient'=>false),
			...
			array('color','.nav-bar-below a','nav_bar_link'),
